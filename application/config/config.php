...
$config['sess_driver'] 				= 'mongo';
$config['sess_cookie_name'] 		= 'ci_session';
$config['sess_expiration'] 			= 172800;
$config['sess_save_path'] 			= 'mongodb://127.0.0.1:27017/ropstam_api|ropstam_api|cc_ci_sessions';
$config['sess_match_ip'] 			= FALSE;
$config['sess_time_to_update'] 		= 172800; //24 hours
$config['sess_regenerate_destroy'] 	= FALSE;
...
$config['csrf_token_name']   = 'csrftestname';//csrf_test_name
$config['csrf_cookie_name']  = 'csrfcookiename';//csrf_cookie_name
