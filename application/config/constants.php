...
$base_url_ = ((isset($_SERVER['HTTP_X_FORWARDED_PROTO']) && $_SERVER['HTTP_X_FORWARDED_PROTO'] == "https") ? "https" : "http");
$base_url_ .= "://". @$_SERVER['HTTP_HOST'];
$base_url_ .= str_replace(basename($_SERVER['SCRIPT_NAME']),"",$_SERVER['SCRIPT_NAME']);
//echo "<pre>"; print_r($_SERVER);exit;
defined('SURL')      		   OR define('SURL', $base_url_); // site url...http://localhost/
